...
public class Events extends javax.swing.JFrame {
    ...
    private javax.swing.JLabel imageLabel;  // Declare the image label
...
scrollPane = new javax.swing.JScrollPane(imageLabel);
...
jPanel2.add(scrollPane, java.awt.BorderLayout.CENTER);
    ...
    if (option == JFileChooser.APPROVE_OPTION) {
        ...
        // ✅ Use fixed size here
        Image img = imageIcon.getImage().getScaledInstance(400, 300, Image.SCALE_SMOOTH);
        imageLabel.setIcon(new ImageIcon(img));

        jPanel2.revalidate();  // refresh panel
        jPanel2.repaint();
